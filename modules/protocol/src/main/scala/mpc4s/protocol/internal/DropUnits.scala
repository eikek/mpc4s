...
// Note: This code has been copied from the scodec project:
// https://github.com/scodec/scodec/blob/1b51857832d54edc9a617da95fed4094776b6bfe/shared/src/main/scala/scodec/codecs/DropUnits.scala
// Project Site: https://github.com/scodec/scodec
// License: 3-Clause BSD

import shapeless._

/**
 * Describes an isomorphism between two `HList`s, `K` and `L`, where
 * `L` has the same shape as `K` except unit values have been removed.
 */
