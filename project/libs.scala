...
object libs {
  ...
  // Apache 2.0
  val minitest = "io.monix" %% "minitest" % "2.9.4"
  ...
  // ASL 2.0
  val `circe-core` = "io.circe" %% "circe-core" % "0.14.1"
  val `circe-generic` = "io.circe" %% "circe-generic" % "0.14.1"
  val `circe-parser` = "io.circe" %% "circe-parser" % "0.14.1"
